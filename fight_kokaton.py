...
class Beam:
    ...
    def __init__(self, bird: Bird):
        ...
        self._img = pg.transform.rotozoom(pg.image.load(f"ex03-20230509/fig/beam.png"), 0, 2.0)  # 画像surface
...
class Beam2:
    ...
    def __init__(self, bird: Bird):
        ...
        self._img = pg.transform.rotozoom(pg.image.load(f"ex03-20230509/fig/beam2.png"), 0, 0.5)  # 画像surface
        self._rct = self._img.get_rect()  # 画像surfaceに対応したrect
        self._rct.left = bird._rct.right  # こうかとんの右側にビームの左側を合わせる
        self._rct.centery = bird._rct.centery
        self._vx, self._vy = +1, 0
